...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="4" style="color:#FF9900"><h3>Favorilerim</h3></td>
				</tr>
				<tr height="30">
				...
				if($FavoriSayisi>0){
					foreach($FavoriKayitlari as $FavoriSatirlar){
						...
						if($UrununUrunTuru == "Telefon"){
							$ResimKlasoruAdi	=	"Telefonlar";
						}elseif($UrununUrunTuru == "Akıllı Saat"){
							$ResimKlasoruAdi	=	"Akıllı Saatler";
						}else{
							$ResimKlasoruAdi	=	"Bilgisayarlar";
						}
