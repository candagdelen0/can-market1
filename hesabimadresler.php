...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="5" style="color:#FF9900"><h3>Adreslerim</h3></td>
				</tr>
				<tr height="30">
					<td colspan="5" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Adreslerinizi görüntüleyebilir ve güncelleyebilirsiniz.</td>
				</tr>
				<tr height="50">
					<td colspan="1" style="background: #0088CC; color: white; font-weight: bold;" align="left">&nbsp;Adresler</td>
					<td colspan="4" style="background: #0088CC; color: white; font-weight: bold;" align="right"><a href="index.php?SK=70" style="text-decoration: none; color: white;">+ Yeni Adres Ekle</a>&nbsp;</td>
				</tr>
				<?php
