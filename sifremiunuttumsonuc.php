...
if(($GelenEmailAdresi!="") or ($GelenTelefonNumarasi!="")){
	...
	if($KullaniciSayisi>0){
		$MailIcerigiHazirla		=	"Merhaba, " . $KullaniciKaydi["IsimSoyisim"] . "<br /><br />Sitemiz üzerinde bulunan hesabınızın şifresini sıfırlamak için lütfen <a href='" . $SiteLinki . "/index.php?SK=43&AktivasyonKodu=" . $KullaniciKaydi["AktivasyonKodu"] . "&Email=" . $KullaniciKaydi["EmailAdresi"] . "'>TIKLAYINIZ</a>.<br /><br />Saygılarımızla, iyi çalışmalar...<br />" . $SiteAdi;
