		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnYeniUrunKayitlari as $EnYeniUrunSatirlari){
					...
					if($EnYeniUrununTuru=="Telefonlar"){
						$EnYeniUrunResimKlasoru =	"Telefonlar";
					}elseif($EnYeniUrununTuru=="Akıllı Saatler"){
						$EnYeniUrunResimKlasoru =	"Akıllı Saatler";
					}elseif($EnYeniUrununTuru=="Bilgisayarlar"){
						$EnYeniUrunResimKlasoru =	"Bilgisayarlar";
					}
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnPopulerUrunKayitlari as $EnPopulerUrunSatirlari){
					...
					if($EnPopulerUrununTuru=="Telefonlar"){
						$EnPopulerUrunResimKlasoru = "Telefonlar";
					}elseif($EnPopulerUrununTuru=="Akıllı Saatler"){
						$EnPopulerUrunResimKlasoru = "Akıllı Saatler";
					}elseif($EnPopulerUrununTuru=="Bilgisayarlar"){
						$EnPopulerUrunResimKlasoru = "Bilgisayarlar";
					}
		...
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				...
				foreach($EnCokSatanUrunKayitlari as $EnCokSatanUrunSatirlari){
					...
					if($EnCokSatanUrununTuru=="Telefonlar"){
						$EnCokSatanUrunResimKlasoru		=	"Telefonlar";
					}elseif($EnCokSatanUrununTuru=="Akıllı Saatler"){
						$EnCokSatanUrunResimKlasoru		=	"Akıllı Saatler";
					}elseif($EnCokSatanUrununTuru=="Bilgisayarlar"){
						$EnCokSatanUrunResimKlasoru		=	"Bilgisayarlar";
					}
