			...
			<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				if($SepettekiUrunSayisi>0){
					...
					foreach($SepettiKayitlar as $SepetSatirlari){
						...
						if($UrununTuru=="Telefonlar"){
							$UrunResimleriKlasoru	=	"Telefon";
						}elseif($UrununTuru=="Akıllı Saatler"){
							$UrunResimleriKlasoru	=	"Akıllı Saat";
						}elseif($UrununTuru=="Bilgisayarlar"){
							$UrunResimleriKlasoru	=	"Bilgisayar";
						}
