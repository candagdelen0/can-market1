		...
		<tr>
			<td width="800" valign="top">
				<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="40" class="KKAlanlari">
						<td height="40" width="800" align="left">Ödeme işleminizde kredi kartı veya ATM(Bankamatik) kartı ile işlem yapabilirsiniz.</td>
					</tr>
					<tr height="10" class="KKAlanlari">
						<td style="font-size: 10px;">&nbsp;</td>
					</tr>
					...
					<tr height="40" class="BHAlanlari" style="display: none;">
						<td height="40" width="800" align="left">Banka havalesi / EFT ile ürün satın alabilmek için, öncelikle alışveriş sepeti tutarını "Ödeme Seçenekleri" sayfasında bulunan herhangi bir hesaba ödeme yaptıktan sonra "Havale Bildirim Formu" aracılığı ile lütfen tarafımıza bilgi veriniz. "Ödeme Yap" butonuna tıkladığınız anda siparişiniz sisteme kayıt edilecektir.</td>
					</tr>
				</table>
			</td>
