		...
		if($GelenSifre!=$GelenSifreTekrar){
			...
			if($KullaniciSayisi>0){
				...
				if($KayitKontrol>0){
					...
					$MailIcerigiHazirla		=	"Merhaba " . $GelenIsimSoyisim . "<br /><br />Sitemize yapmış olduğunuz üyelik kaydını tamamlamak için lütfen <a href='" . $SiteLinki . "/aktivasyon.php?AktivasyonKodu=" . $AktivasyonKodu . "&Email=" . $GelenEmailAdresi . "'>TIKLAYINIZ</a>.<br /><br />" . $SiteAdi;
